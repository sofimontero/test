sap.ui.define([
	...
	return Controller.extend("sap.btp.helloworldui5.TestPage", {
		onInit: function () {
			...
			this.model.loadData(sap.ui.require.toUrl("sap/btp/helloworldui5/localService/mockdata/products.json"));
